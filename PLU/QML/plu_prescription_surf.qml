...
<qgis simplifyAlgorithm="0" simplifyMaxScale="1" version="3.10.3-A Coruña" labelsEnabled="0" maxScale="0" minScale="1e+08" simplifyLocal="1" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" readOnly="0" simplifyDrawingHints="1">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" type="RuleRenderer" symbollevels="1">
    <rules key="{ba670300-265a-4a24-a2ef-415cde241c3d}">
      <rule filter="TYPEPSC = '01'" label="01 – Espace boisé classé" key="{69358c31-2473-4356-9738-701789afddf1}" symbol="0"/>
      ...
      <rule filter="TYPEPSC = '03'" label="03 - Secteur avec disposition de reconstruction/démolition" key="{fc47c9e8-723c-48af-a666-db24c0c91218}" symbol="4"/>
      <rule filter="TYPEPSC = '04'" label="04 - Périmètre issu des PDU sur obligation de stationnement" key="{396d4eab-5dd9-4c35-a42a-9c5aca477f06}" symbol="5"/>
      <rule filter="TYPEPSC = '05' AND STYPEPSC IN ('00', '01', '02', '03', '04')" label="05-00 à 04 - Emplacement réservé" key="{36c51ba5-e7a4-4175-bc5e-4f2ed4a72e5c}" symbol="6"/>
      <rule filter="TYPEPSC = '05' AND STYPEPSC = '05'" label="05-05 - Emplacement réservé logement social/mixité sociale" key="{7892e713-a9cb-4ef6-a5de-65551fcf39df}" symbol="7"/>
      <rule filter="TYPEPSC = '05' AND STYPEPSC = '06'" label="05-06 - Servitude de localisation des voies, ouvrages publics, installations d'intérêt général et espaces verts en zone U ou AU" key="{9d997230-236f-4519-927f-e984d5aadbb9}" symbol="8"/>
      ...
      <rule filter="TYPEPSC = '08'" label="08 - Terrain cultivé ou non bâti à protéger en zone urbaine" key="{132e9085-c3b8-4517-ad69-2bb0620b1484}" symbol="12"/>
      <rule filter="TYPEPSC = '13'" label="13 - Zone à aménager en vue de la pratique du ski" key="{3bc951d2-67dc-4e27-bf87-657e3e0e9378}" symbol="13"/>
      <rule filter="TYPEPSC = '14'" label="14 - Secteur de plan de masse" key="{857af8f9-fced-4bea-bb1a-11de34b17572}" symbol="14"/>
      <rule filter="TYPEPSC = '15'" label="15 – Règles d'implantation des constructions" key="{9d6e2671-d712-438d-9db7-b47c3d5eb027}" symbol="15"/>
      <rule filter="TYPEPSC = '16' AND STYPEPSC IN ('00', '01', '02', '04', '05')" label="16-00 à 02 et 04 à 05 - Constructions et installations nécessaires à des équipements collectifs" key="{3d1a33c4-2293-4a76-b614-3f419b987f3b}" symbol="16"/>
      <rule filter="TYPEPSC = '16' AND STYPEPSC = '03'" label="16-03 - Secteur de taille et de capacité d’accueil limité (STECAL)" key="{27f8a02f-8f57-45bf-a561-06bf129d03c4}" symbol="17"/>
      <rule filter="TYPEPSC = '17'" label="17 - Secteur à programme de logements mixité sociale" key="{f8e2f359-e919-44b1-a7d4-df67c27e2994}" symbol="18"/>
      <rule filter="TYPEPSC = '18'" label="18 - Secteur comportant des orientations d’aménagement et de programmation (OAP)" key="{6a287ff2-2c47-4313-887c-2abc30962588}" symbol="19"/>
      <rule filter="TYPEPSC = '19'" label="19 - Secteur protégé en raison de la richesse du sol et du sous-sol" key="{aa951d3d-76e5-48f4-bf49-cee6f4fed7ac}" symbol="20"/>
      <rule filter="TYPEPSC = '20'" label="20 - Secteur à transfert de constructibilité en zone N" key="{2e114da4-4474-4397-8c89-c27b10eadd4c}" symbol="21"/>
      <rule filter="TYPEPSC = '22'" label="22 - Diversité commerciale à protéger ou à développer" key="{7735f11c-77fc-462e-b667-6ac6e31686fe}" symbol="22"/>
      <rule filter="TYPEPSC = '23'" label="23 - Secteur avec taille minimale des logements en zone U et AU" key="{921024d8-86b2-4682-8274-7c9e725f4ee8}" symbol="23"/>
      <rule filter="TYPEPSC = '24'" label="24 - Voies, chemins, transport public à conserver et à créer " key="{6f2f4df7-2f61-40bf-8c30-5482e1810993}" symbol="24"/>
      <rule filter="TYPEPSC = '25'" label="25 - Éléments de continuité écologique et trame verte et bleue" key="{12c47c72-0414-48a0-a618-48d17bbc2ffd}" symbol="25"/>
      <rule filter="TYPEPSC = '26'" label="26 - Secteur de performance énergétique" key="{b6010fa1-be9b-440d-afbc-0373766608b9}" symbol="26"/>
      <rule filter="TYPEPSC = '27'" label="27 - Secteur d’aménagement numérique" key="{14e1c89c-1caa-4df9-8423-bc738d9206b7}" symbol="27"/>
      <rule filter="TYPEPSC = '28'" label="28 - Conditions de desserte" key="{82dc71ff-9a70-444e-b973-0b0b6e885a2f}" symbol="28"/>
      <rule filter="TYPEPSC = '29'" label="29 - Secteur avec densité minimale de construction" key="{2c76eb85-61e6-4116-9df8-c4b57286ea52}" symbol="29"/>
      <rule filter="TYPEPSC = '30'" label="30 - Majoration des volumes constructibles" key="{fffd1c3d-2ffe-46d2-80b6-dcd8c6b29c9f}" symbol="30"/>
      <rule filter="TYPEPSC = '31'" label="31 - Espaces remarquables du littoral" key="{a727486e-ca16-4771-a59a-b59f9c733497}" symbol="31"/>
      <rule filter="TYPEPSC = '32'" label="32 - Exclusion protection de plans d'eau de faible importance" key="{80796f8b-7196-4a62-81ea-298012d8551f}" symbol="32"/>
      <rule filter="TYPEPSC = '33'" label="33 - Secteur de dérogation aux protections des rives des plans d'eau en zone de montagne" key="{18c65512-4ec7-463f-8f54-76b93acbcca1}" symbol="33"/>
      <rule filter="TYPEPSC = '34'" label="34 - Espaces, paysages et milieux caractéristiques du patrimoine naturel et culturel montagnard à préserver" key="{6ba2177d-4b99-41d4-9858-e995fe9932e7}" symbol="34"/>
      <rule filter="TYPEPSC = '35'" label="35 - Terres nécessaires au maintien et au développement des activités agricoles, pastorales et forestières à préserver" key="{e38c0f5f-fda0-42e5-a640-432d474b612a}" symbol="35"/>
      <rule filter="TYPEPSC = '36'" label="36 - Mixité des destinations ou sous-destinations" key="{8aae8a18-98fa-4aed-a73f-8bcf984a54f6}" symbol="36"/>
      <rule filter="TYPEPSC = '37'" label="37 - Règles différenciées entre le rez-de-chaussée et les étages supérieurs des constructions" key="{47b670cc-faab-4734-84bb-302bcc03f6c9}" symbol="37"/>
      <rule filter="TYPEPSC = '38'" label="38 - Emprise au sol" key="{7469ddb4-e736-4ade-8d2b-f10f9d34b8b1}" symbol="38"/>
      <rule filter="TYPEPSC = '39'" label="39 - Hauteur" key="{6134ca3b-33a6-4561-9c39-a08e7ae049ee}" symbol="39"/>
      <rule filter="TYPEPSC = '40'" label="40 - Volumétrie" key="{00ff8300-fdb7-4aba-962e-d8db0dca3faf}" symbol="40"/>
      <rule filter="TYPEPSC = '41'" label="41 - Aspect extérieur" key="{2058b038-746b-4e75-80f3-5cf320f05155}" symbol="41"/>
      <rule filter="TYPEPSC = '42'" label="42 - Coefficient de biotope par surface" key="{d0102a5d-6672-45d8-8e28-7d637f4db194}" symbol="42"/>
      <rule filter="TYPEPSC = '43'" label="43 - Réalisation d'espaces libres, plantations, aires de jeux et de loisirs" key="{0847a332-4770-4560-bab0-f8e008a3e859}" symbol="43"/>
      <rule filter="TYPEPSC = '44'" label="44 - Stationnement" key="{162c29eb-21d6-4b90-8d5d-a94f158986d2}" symbol="44"/>
      <rule filter="TYPEPSC = '45'" label="45 - Zone d'aménagement concerté" key="{49ebb52e-f7d6-4e95-a37f-adc5bab3791b}" symbol="45"/>
      <rule filter="TYPEPSC = '46'" label="46 - Espace boisé antérieur au XXe siècle" key="{3e9c3c9c-3cc5-41e1-9fa1-d50861e85c31}" symbol="46"/>
      <rule filter="TYPEPSC = '47'" label="47 - Desserte par les réseaux" key="{e7bdf797-df61-45b9-aecd-77237063b6c5}" symbol="47"/>
      <rule filter="TYPEPSC = '48'" label="48 - Mesures pour limiter l'imperméabilité des sols" key="{89d5641c-ebc9-4e41-b398-89a32e41c7cf}" symbol="48"/>
      <rule filter="TYPEPSC = '49'" label="49 - Opération d'ensemble imposée en zone AU" key="{d00a7ff9-85f7-4e32-ab67-d4293eef7e43}" symbol="49"/>
      <rule filter="TYPEPSC = '50'" label="50 - Interdiction types d'activités, destinations, sous-destinations" key="{735ab633-e798-46ef-a393-48d8a52b54c1}" symbol="50"/>
      <rule filter="TYPEPSC = '51'" label="51 - Autorisation sous conditions types d'activités, destinations, sous-destinations" key="{bf9343ba-9b3c-4c74-af9b-2c27e69e2ac1}" symbol="51"/>
      <rule filter="TYPEPSC = '52'" label="52 - Infrastructures et équipements logistiques à préserver ou à développer en zones U et AU" key="{e088157b-1166-4539-8004-69a252c82370}" symbol="52"/>
      <rule filter="TYPEPSC = '97' AND STYPEPSC = '00'" label="97-00 - Périmètre d'application d'une pièce écrite territorialisée" key="{d0316d51-41e3-417b-9645-83950b1d8f7e}" symbol="53"/>
      <rule filter="TYPEPSC = '97' AND STYPEPSC = '01'" label="97-01 - Périmètre couvert par un plan de secteur" key="{4c9f2afd-ac75-4d2e-85ad-6f6882117005}" symbol="54"/>
      <rule filter="TYPEPSC = '99'" label="99 - Autre" key="{1f1b3701-ebdc-4fbf-98e3-94cdde3e19e6}" symbol="55"/>
    ...
    <symbols>
      <symbol name="0" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        <layer enabled="1" pass="0" locked="0" class="PointPatternFill">
          ...
          <symbol name="@0@0" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
      ...
      <symbol name="12" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        ...
        <layer enabled="1" pass="1" locked="0" class="PointPatternFill">
          ...
          <symbol name="@12@1" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="FontMarker">
              <prop k="angle" v="0"/>
              <prop k="chr" v="ü"/>
      ...
      <symbol name="13" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        ...
        <layer enabled="1" pass="0" locked="0" class="PointPatternFill">
          ...
          <symbol name="@13@1" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="SimpleMarker">
              <prop k="angle" v="0"/>
      ...
      <symbol name="14" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        ...
        <layer enabled="1" pass="1" locked="0" class="LinePatternFill">
          ...
          <symbol name="@14@1" type="line" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="SimpleLine">
              <prop k="capstyle" v="square"/>
              <prop k="customdash" v="5;2"/>
              <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol name="15" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        ...
        <layer enabled="1" pass="1" locked="0" class="LinePatternFill">
          ...
          <symbol name="@15@1" type="line" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="SimpleLine">
              <prop k="capstyle" v="square"/>
              <prop k="customdash" v="5;2"/>
              <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
        ...
        <layer enabled="1" pass="1" locked="0" class="PointPatternFill">
          ...
          <symbol name="@15@2" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="FontMarker">
              <prop k="angle" v="0"/>
              <prop k="chr" v="V"/>
      ...
      <symbol name="18" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        <layer enabled="1" pass="1" locked="0" class="PointPatternFill">
          ...
          <symbol name="@18@0" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="FontMarker">
              <prop k="angle" v="0"/>
              <prop k="chr" v="z"/>
      ...
      <symbol name="20" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        <layer enabled="1" pass="1" locked="0" class="PointPatternFill">
          ...
          <symbol name="@20@0" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="FontMarker">
              <prop k="angle" v="0"/>
              <prop k="chr" v="°"/>
      ...
      <symbol name="23" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        <layer enabled="1" pass="1" locked="0" class="PointPatternFill">
          ...
          <symbol name="@23@0" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="SimpleMarker">
              <prop k="angle" v="0"/>
      ...
      <symbol name="24" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        <layer enabled="1" pass="1" locked="0" class="HashLine">
          ...
          <symbol name="@24@0" type="line" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="SimpleLine">
              <prop k="capstyle" v="flat"/>
              <prop k="customdash" v="5;2"/>
              <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol name="25" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        <layer enabled="1" pass="1" locked="0" class="HashLine">
          ...
          <symbol name="@25@0" type="line" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="SimpleLine">
              <prop k="capstyle" v="flat"/>
              <prop k="customdash" v="5;2"/>
              <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol name="26" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        <layer enabled="1" pass="1" locked="0" class="PointPatternFill">
          ...
          <symbol name="@26@0" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="SimpleMarker">
              <prop k="angle" v="0"/>
              <prop k="color" v="255,0,0,255"/>
              <prop k="horizontal_anchor_point" v="1"/>
      ...
      <symbol name="31" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        <layer enabled="1" pass="1" locked="0" class="PointPatternFill">
          ...
          <symbol name="@31@0" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="FontMarker">
              <prop k="angle" v="0"/>
              <prop k="chr" v="Â"/>
      ...
      <symbol name="32" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        ...
        <layer enabled="1" pass="1" locked="0" class="LinePatternFill">
          ...
          <symbol name="@32@1" type="line" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="SimpleLine">
              <prop k="capstyle" v="flat"/>
              <prop k="customdash" v="5;2"/>
              <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol name="36" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        ...
        <layer enabled="1" pass="1" locked="0" class="PointPatternFill">
          ...
          <symbol name="@36@1" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="SimpleMarker">
              <prop k="angle" v="0"/>
      ...
      <symbol name="38" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        <layer enabled="1" pass="0" locked="0" class="PointPatternFill">
          ...
          <symbol name="@38@0" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="FontMarker">
              <prop k="angle" v="0"/>
              <prop k="chr" v="¿"/>
      ...
      <symbol name="39" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        <layer enabled="1" pass="1" locked="0" class="PointPatternFill">
          ...
          <symbol name="@39@0" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="FontMarker">
              <prop k="angle" v="90"/>
              <prop k="chr" v="±"/>
              <prop k="color" v="138,77,211,255"/>
      ...
      <symbol name="41" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        <layer enabled="1" pass="0" locked="0" class="PointPatternFill">
          ...
          <symbol name="@41@0" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="FontMarker">
              <prop k="angle" v="0"/>
              <prop k="chr" v="p"/>
      ...
      <symbol name="42" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        <layer enabled="1" pass="0" locked="0" class="PointPatternFill">
          ...
          <symbol name="@42@0" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="FontMarker">
              <prop k="angle" v="0"/>
              <prop k="chr" v="á"/>
      ...
      <symbol name="43" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        <layer enabled="1" pass="1" locked="0" class="LinePatternFill">
          ...
          <symbol name="@43@0" type="line" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="SimpleLine">
              <prop k="capstyle" v="square"/>
              <prop k="customdash" v="5;2"/>
              <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
        ...
        <layer enabled="1" pass="1" locked="0" class="LinePatternFill">
          ...
          <symbol name="@43@1" type="line" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="SimpleLine">
              <prop k="capstyle" v="square"/>
              <prop k="customdash" v="5;2"/>
              <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol name="44" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        <layer enabled="1" pass="0" locked="0" class="PointPatternFill">
          ...
          <symbol name="@44@0" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="SimpleMarker">
              <prop k="angle" v="0"/>
      ...
      <symbol name="46" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        <layer enabled="1" pass="0" locked="0" class="PointPatternFill">
          ...
          <symbol name="@46@0" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="SimpleMarker">
              <prop k="angle" v="0"/>
      ...
      <symbol name="47" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        ...
        <layer enabled="1" pass="1" locked="0" class="PointPatternFill">
          ...
          <symbol name="@47@1" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="FontMarker">
              <prop k="angle" v="0"/>
              <prop k="chr" v="~"/>
      ...
      <symbol name="48" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        ...
        <layer enabled="1" pass="1" locked="0" class="PointPatternFill">
          ...
          <symbol name="@48@1" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="FontMarker">
              <prop k="angle" v="0"/>
              <prop k="chr" v="S"/>
      ...
      <symbol name="49" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        ...
        <layer enabled="1" pass="1" locked="0" class="PointPatternFill">
          ...
          <symbol name="@49@1" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="FontMarker">
              <prop k="angle" v="0"/>
              <prop k="chr" v="ù"/>
      ...
      <symbol name="51" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        ...
        <layer enabled="1" pass="1" locked="0" class="PointPatternFill">
          ...
          <symbol name="@51@1" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="FontMarker">
              <prop k="angle" v="0"/>
              <prop k="chr" v="R"/>
              <prop k="color" v="148,10,189,255"/>
      ...
      <symbol name="52" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        ...
        <layer enabled="1" pass="0" locked="0" class="PointPatternFill">
          ...
          <symbol name="@52@1" type="marker" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="FontMarker">
              <prop k="angle" v="0"/>
              <prop k="chr" v="q"/>
      ...
      <symbol name="6" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        <layer enabled="1" pass="1" locked="0" class="LinePatternFill">
          ...
          <symbol name="@6@0" type="line" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="SimpleLine">
              <prop k="capstyle" v="flat"/>
              <prop k="customdash" v="5;2"/>
              <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
        ...
        <layer enabled="1" pass="1" locked="0" class="LinePatternFill">
          ...
          <symbol name="@6@1" type="line" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="SimpleLine">
              <prop k="capstyle" v="flat"/>
              <prop k="customdash" v="5;2"/>
              <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol name="7" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
        <layer enabled="1" pass="1" locked="0" class="LinePatternFill">
          ...
          <symbol name="@7@0" type="line" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="SimpleLine">
              <prop k="capstyle" v="flat"/>
              <prop k="customdash" v="5;2"/>
              <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
        ...
        <layer enabled="1" pass="1" locked="0" class="LinePatternFill">
          ...
          <symbol name="@7@1" type="line" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="SimpleLine">
              <prop k="capstyle" v="flat"/>
              <prop k="customdash" v="5;2"/>
              <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
